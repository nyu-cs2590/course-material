...
\title[DS-GA.1011]{Aligning language models}
\author[He He]{He He
}
\institute[NYU]{
...
\begin{frame}
    ...
    The \blue{technical} problem: how to adapt the language model to the intended task (which is not language modeling) 
    ...
    \begin{columns}
        ...
        \begin{column}{0.6\textwidth}
            \begin{itemize}
                ...
                \item Goal: make LMs the best assistant to humans 
...
\begin{frame}
    ...
    \pause
    \think{How to get $r(x_{1:T})$ (i.e. reward of a generation)?} (in two weeks!)
\end{frame}
