...
\title[DS-GA.1011]{Evaluation and Benchmarking}
\author[He He]{He He
}
\institute[NYU]{
...
\begin{frame}
    ...
    \begin{wideitemize}
        \item 11/27: guest lecture on LLM reasoning
        \item Thanksgiving
        \item 12/4 and 12/5: project presentation
        \item No lecture in the last week (legislative Friday)
        \item Use office hours for any last-minute project help
        \item 12/12: project report due
    \end{wideitemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \includegraphics[width=0.7\textwidth]{figures/ppl}
        \caption{[Isik et al., 2024]}
    \end{figure}
...
\begin{frame}
    ...
    \begin{figure}
        \includegraphics[width=0.7\textwidth]{figures/gsm8k}
        \caption{[Cobbe et al., 2021]}
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \includegraphics[width=0.7\textwidth]{figures/arena-chat}
...
\begin{frame}
    {Ranking LLMs}
    \begin{wideitemize}[<+->]
        \item Average win rate: need data for every pair - expensive!
        \item Elo rating: supports sequential updates 
            \begin{align}
                E_A &= \frac{1}{1 + 10^{(R_B-R_A)/400}} \\
                R'_A &= R_A + K\cdot (S_A - E_A)
            \end{align}
            \begin{itemize}
                \item $E_A$: expected win rate
                \item $S_A$: actual win (1) or lose (0)
                \item $S'_A$: new rating
            \end{itemize}
        \item Ratings can have large variance though
        \item Also costly!
    \end{wideitemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \includegraphics[width=0.7\textwidth]{figures/alpacaeval}
...
\begin{frame}
    ...
    \begin{figure}
        \includegraphics[width=0.7\textwidth]{figures/alpacaeval-corr}
    \end{figure}
\end{frame}

\begin{frame}
    {LLM as a judge}
    Spurious correlation between length and rating:
    increasing length can improve model rating!
    \begin{figure}
    ...
    \begin{columns}
        ...
        \begin{column}{0.6\textwidth}
            \begin{itemize}
                ...
                %\item How to make sure the distractor sentence changes the model prediction?
                %    \begin{itemize}
...
\begin{frame}
    {Fairness and bias metrics}
    What would be a non-stereotypical model?\pause %$\quad$ The definition of fairness is debatable.
