...
{Basic information}
    \begin{wideitemize}
        \item {\bf Instructor}: He He
        \item {\bf TAs}: Xiang Pan, Haitian Jiang, Arun Purohit
        \item You can find all information about this course on the {\bf website}: \url{https://nyu-cs2590.github.io/spring2025/}.
        \item Best way to communicate with us is through \textbf{Campuswire} (register at \url{https://campuswire.com/p/GDE4D5420}).
...
\begin{frame}
    {Grading}
    \begin{wideitemize}
        \item \textbf{Assignment (60\%)}: 4 assignments (written + coding questions), each counting 15\%
        \item \textbf{Quizzes (15\%)}: to encourage attendence to guest lectures, we will have an online quiz about each lecture.
        \item \textbf{Final exam (25\%)}: there will be an online exam through Gradescope.
    \end{wideitemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        \item First public demonstration of a machine translation system
        \item The Russian-English translation program:\\
            \begin{center}
            \includegraphics[height=3cm]{figures/ibm-experiment}
            \end{center}
        \item A vocabulary of \blue{250 words}
        \item Hand-coded \blue{6 grammar rules}, \eg\\
            \texttt{
...
\begin{frame}
    ...
    \begin{wideitemize}
        ...
        \item Statistical learning became the main driving force of NLP.
    \end{wideitemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{wideitemize}
        ...
        \item All NLP models are neural networks nowadays.
    \end{wideitemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{wideitemize}
        ...
        \item More recently, large-scale language modeling enables models with general capabilities (\eg ChatGPT by OpenAI).
        \item The paradigm shift: \blue{transfer learning $\rightarrow$ ``elicitation''}
    \end{wideitemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{wideitemize}
        ...
        \item {\bf Guest lectures on advanced topics} \\
            \begin{itemize}
                \item RAG, agents, open-source LLMs 
            \end{itemize}
    \end{wideitemize}
\end{frame}
...
\begin{frame}
    ...
    % TODO: split the two, add more examples, byte as tokens
