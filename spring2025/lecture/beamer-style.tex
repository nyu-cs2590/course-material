...
% spacing
\setlength{\intextsep}{0pt} % Reduce space around floating figures
\setlength{\belowcaptionskip}{-5pt} % Reduce space below captions
...
\newcommand<>{\mgray}[1]{{\color#2{gray}#1}}
...
\hypersetup{
    ...
    linkcolor=blue,        % Color for internal links (like sections)
    filecolor=blue,    % Color for linked files
...
% Set global item separation
\setlength{\itemsep}{1em} % or any value you prefer
%\setlength{\enumerateitemsep}{5pt}
%\setlength{\descriptionitemsep}{5pt}
